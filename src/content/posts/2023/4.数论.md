...
![img](4.数论/v2-a24e0b41ab2e0b5e4f86af8107af3ee1_720w-1721820782754-2.webp)

![image-20231123132916469](4.数论/image-20231123132916469-1721820782755-3.png)

在对mod构造的一个集合来说，执行一个操作肯定有着对应的逆向操作可以达到同一个结果。这也是之后需要了解的**逆元**

然后看到[知乎](https://zhuanlan.zhihu.com/p/451041897)的文章，严谨的说法是这样的：

![image-20231123194359803](4.数论/image-20231123194359803-1721820782755-4.png)

![image-20231123194424351](4.数论/image-20231123194424351-1721820782755-5.png)
...
![img](4.数论/v2-9c9e1575adfbd3a78a25e3788f73b6b7_1440w-1721820782755-6.png)

原理是用两者小的数据凑大的数据，余下的数据来凑次小的数据，如此循环？

![image-20231123204829718](4.数论/image-20231123204829718-1721820782755-7.png)

> c++的a/b是向下取整

![image-20231123205015441](4.数论/image-20231123205015441-1721820782755-8.png)
...
![image-20230907103114003](4.数论/image-20230907103114003-1721820782755-9.png)
...
![image-20231123210020358](4.数论/image-20231123210020358-1721820782755-10.png)

![img](/v2-83cba3001fa69e19e6f937848798ee94_1440w-1721820782755-11.png)

![image-20231123210330465](4.数论/image-20231123210330465-1721820782755-12.png)
...
![image-20231125100410490](4.数论/image-20231125100410490-1721820782755-13.png)
...
![image-20231123210547391](4.数论/image-20231123210547391-1721820782755-14.png)
...
![image-20231124174133657](4.数论/image-20231124174133657-1721820782755-15.png)
...
![image-20230907153701347](4.数论/image-20230907153701347-1721820782755-16.png)
...
![img](4.数论/v2-e99e321dcff33699093cde2876424dbe_720w-1721820782755-17.webp)
...
![image-20231125133148335](4.数论/image-20231125133148335-1721820782755-18.png)
...
![image-20231125140647348](4.数论/image-20231125140647348-1721820782755-19.png)

试除法求取欧拉函数，将质数一个一个除掉。

![image-20231125142303255](4.数论/image-20231125142303255-1721820782755-20.png)
...
![img](4.数论/v2-43c417f37ca53e2e888bc01a0333229e_720w-1721820782755-21.png)
...
![image-20230907224817684](4.数论/image-20230907224817684-1721820782755-22.png)
...
![image-20231126131003658](4.数论/image-20231126131003658-1721820782755-23.png)

我们可以使用构造法，将方程构造成适合求解逆元的形式：

![image-20231126131047638](4.数论/image-20231126131047638-1721820782755-24.png)
...
- 然后计算，每一个方程中的`Ci = M/p`，这里的p是每一个方程mod的数据。对于每一个`C1i`，我们求解它的逆元`Ci^-1`
  ...
  ![image-20231126133716942](4.数论/image-20231126133716942-1721820782755-25.png)

  ![image-20231126135202640](4.数论/image-20231126135202640-1721820782755-26.png)
...
![image](4.数论/5bynwh32a2-1721820782755-27.png)

构造增广矩阵，即系数矩阵A增加上常数向量b（A|b）  

![image](4.数论/ahv19vepb0-1721820782755-28.png)

 通过以交换行、某行乘以非负常数和两行相加这三种初等变化将原系统转化为更简单的三角形式（triangular form）    

 注：这里的初等变化可以通过系数矩阵A乘上初等矩阵E来实现  

![image](4.数论/s7at02swx8-1721820782755-29.png)

 从而得到简化的三角方阵组，注意它更容易解

![image](4.数论/9uo7gd9be7-1721820782755-30.png)
...
![img](4.数论/f17gajsz1a-1721820782755-31.png)
...
![定义](4.数论/Sieve_of_Eratosthenes_animation.gif)
...
![img](4.数论/webp-1721820782756-32.webp)
...
![2475558-a800e7d9bea07740](4.数论/2475558-a800e7d9bea07740-1721820782756-40.webp)

**2.根据对数性质进行转换**

![2475558-576a246a59455baa](4.数论/2475558-576a246a59455baa-1721820782756-33.webp)

![2475558-14dada8828552c4c](4.数论/2475558-14dada8828552c4c-1721820782756-34.webp)

- 消除相同项![2475558-cd4aabbfde8e8344](4.数论/2475558-cd4aabbfde8e8344-1721820782756-35.webp)

- 到这就已经将阶乘转换成对数连加，极大的降低了运算的复杂度。另外，依据组合数性质：![2475558-5cf3a8040bf13892](4.数论/2475558-5cf3a8040bf13892-1721820782756-36.webp)
...
![img](4.数论/2475558-b30e33e52cf70ad7-1721820782756-37.webp)
...
![image-20230317192018240](4.数论/image-20230317192018240-1721820782756-38.png)

![image-20230317192035378](4.数论/image-20230317192035378-1721820782756-39.png)
