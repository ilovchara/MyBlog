...
![树](2.图论/20240511171215-1723797363701-239.png)
...
![二叉树](2.图论/20240511171342-1723797363701-238.png)
...
![完全二叉树与非完全二叉树](2.图论/20220218174000.png)
...
![image-20230216134441813](2.图论/image-20230216134441813-16923744802222-1721820002716-4-1723797363701-243.png)
...
![二叉链节点](2.图论/20240511171434-1723797363701-248.png)
...
![二叉树的链式存储结构](2.图论/20240511171446-1723797363701-241.png)
...
![image-20241013170507586](2.图论/image-20241013170507586.png)
...
![二叉树的前序遍历](2.图论/20240511171628-1723797363701-242.png)
...
![二叉树的中序遍历](2.图论/20240511171643-1723797363701-247.png)
...
![img](2.图论/1590962-20190308110049685-131632486.png)

**第二步：**确认了根节点，再来看中序遍历，中序遍历中根节点A的左边是**`CBD`**，右边是**`EF`**，所有可以确定二叉树既有左子树又有右子树

![img](2.图论/1590962-20190308111832076-64554868.png)

**第三步：**先来分析左子树**`CBD`，**那么`CBD`谁来做`A`的左子树呢？这个时候**不能**直接用中序遍历的特点（`左->根->右`）得出左子树应该是这个样子

![img](2.图论/1590962-20190308104123264-1263028885.png)

因为有两种情况都满足中序遍历为**`CBD`**

![img](2.图论/1590962-20190308104526312-43746275.png)
...
![img](2.图论/v2-09fa3fa35e5411444b327d9cb9a31057_1440w.webp)

- 合并1号和3号所在的集合，1号为代表元素

![img](2.图论/v2-3bf6c1a6ecf87fa93f4dbab2012446c7_1440w.webp)

- 合并3号和2号所在的集合，合并代表元素，组合成一个新集合。

![img](2.图论/v2-be12a6c795572d2acd77dcd49de35127_1440w.webp)

重复上述结果就可以构成一个并查集。并查集是一个**树**状的结构，要寻找集合的代表元素，只需要一层一层往上访问**父节点**（图中箭头所指的圆），直达树的**根节点**（图中橙色的圆）即可。根节点的父节点是它自己。可以直接把它画成一棵树：

![img](2.图论/v2-cca3ddf5806a221201ed78caf1d27041_1440w.png)
...
![img](2.图论/v2-49b5dd7af650192373e96d29f9c4b8cf_1440w.webp)

现在我们要`merge(2,3)`，于是从`2`找到`1`，`fa[1]=3`，于是变成了这样：

![img](2.图论/v2-6f85fc7c5578aa20400ac56f0da31e37_1440w.webp)

然后我们又找来一个元素`4`，并需要执行`merge(2,4)`：

![img](2.图论/v2-1d3ef8a42d424cbec76135ce8a494ff7_1440w.webp)

从`2`找到`1`，再找到`3`，然后`fa[3]=4`，于是变成了这样：

![img](2.图论/v2-23c367515ace6fc0603692dfd865849f_1440w.webp)

这样可能会形成一条长长的**链**，随着链越来越长，我们想要从底部找到根节点会变得越来越难。怎么解决呢？我们可以使用**路径压缩**的方法。既然我们只关心一个元素对应的**根节点**，那我们希望每个元素到根节点的路径尽可能短，最好只需要一步，像这样：

![img](2.图论/v2-c2f835398a3e54d8209bf5e034ac6820_1440w.png)
...
![img](2.图论/19-01-1728821802950-29.png)
...
![img](2.图论/19-01-1728821813926-32.png)

![img](2.图论/19-04-1728821859579-35.png)
...
![img](2.图论/alg-tree-hafman-2.png)
...
![二叉搜索树](2.图论/20240511171406-1723797363701-240.png)
...
![img](2.图论/f23d8aac8eb754336f05a88e45ec67f7.png)
...
![img](2.图论/v2-e090a8e3171c8db07e1cda720039e700_1440w.webp)

下面的也不是平衡二叉树，因为虽然任何一个结点的左子树与右子树都是平衡二叉树，但**高度之差已经超过 1 。**

![img](2.图论/v2-7b3cbb7cf1d996c072516b7146144e52_1440w.webp)
...
![img](2.图论/v2-6f2e86b1231b5df131813dc45f8f98cb_1440w.webp)

![img](2.图论/v2-7e5f77810ff2a3a0ae6ae0c0d9443ac1_1440w.webp)

![img](2.图论/v2-ba3929eafa5c6a32b1db0402850a321d_1440w.webp)
...
![img](2.图论/v2-b783aaef2f74f6edbc789a9c58c3add8_1440w.webp)

例如在此平衡二叉树插入节点 `99` ，树的结构就变了。由于插入一个节点会更新平衡因子，也就导致了根节点的平衡因子大于`2`了，就导致了这个树的平衡性被破坏了。

![动图](2.图论/v2-2ddb0f9b832fff594e294dffc299b373_b.webp)
...
![img](2.图论/v2-0a757b848f85f3531b0789fd3d79f0b3_1440w.webp)
...
![动图](2.图论/v2-db1cdb0da952a71f9b6d64b2608467eb_b.webp)
...
![动图](2.图论/v2-05246384c1c16537ca6176983bdb2627_b.webp)
...
![img](2.图论/20200901114718174.png)
...
![在这里插入图片描述](2.图论/20210410220909965.png)

看看**黑色完美平衡**的效果，去掉 `rbt`中的红色节点，会得到 一个四叉树，从根节点到每一个叶子，高度相同，就是`rbt`的`root`到叶子的黑色路径长度。

![在这里插入图片描述](2.图论/41804394324546bebdfe22cd1c7a5bcc.png)
...
![在这里插入图片描述](2.图论/ba1adc2895cf4b1aaef2e7088d9f6a69.webp)

![img](2.图论/dea622e0576539552458e3afcffb1f59.png)

- **右旋**：以某个结点作为支点(`pivot`)，其父节点（子树的`root`）旋转为自己的右子树（**右旋**），`pivot`的原右子树变成 原`root`节点的 左子树，`pivot`的原左子树保持不变。



![在这里插入图片描述](2.图论/96a7aa160f13424abb4acd1ada47edbf.webp)

![在这里插入图片描述](2.图论/82f3502b5be24051bd7688b1e0f36135.png)
...
![在这里插入图片描述](2.图论/20210412094118977.png)

- **插入节点的父节点为黑色**

由于插入的节点是红色的，当插入节点的父节点是黑色时，不会影响红黑树的平衡。**直接插入无需做自平衡**。

![在这里插入图片描述](2.图论/20210412094724987.png)
...
![在这里插入图片描述](2.图论/20210412100154174.png)
...
![在这里插入图片描述](2.图论/2021041210371914.png)
...
![在这里插入图片描述](2.图论/20210412104637494.png)

- **`LL`型失衡**

新插入节点，为其父节点的左子节点(`LL`红色情况)， 插入后 就是`LL `型失衡

![在这里插入图片描述](2.图论/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0ZhbGxpbmdfc3RhcnNf,size_16,color_FFFFFF,t_70.png)
...
![在这里插入图片描述](2.图论/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0ZhbGxpbmdfc3RhcnNf,size_16,color_FFFFFF,t_70-1728877618405-27.png)

**`LR`型失衡**

细分场景 2： 新插入节点，为其父节点的右子节点(LR红色情况)， 插入后 就是LR 型失衡

![在这里插入图片描述](2.图论/20210412153113242.png)
...
![在这里插入图片描述](2.图论/20210412153954767.png)

- **叔叔为黑节点，父亲为红色，并且父亲节点是祖父节点的右子节点**

![在这里插入图片描述](2.图论/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0ZhbGxpbmdfc3RhcnNf,size_16,color_FFFFFF,t_70-1728877983326-34.png)

- **`RR`型失衡**

新插入节点，为其父节点的右子节点(RR红色情况)

![在这里插入图片描述](2.图论/20210412155529702.png)
...
![在这里插入图片描述](2.图论/20210412160829355.png)

- `RL`型失衡

新插入节点，为其父节点的左子节点(`RL`红色情况)

![在这里插入图片描述](2.图论/20210412161045393.png)
...
![在这里插入图片描述](2.图论/20210412161924591.png)
...
![image-20201222211717542](2.图论/image-20201222211717542.b4ba77d6.png)
...
![image-20201222212402348](2.图论/image-20201222212402348.0a394a57.png)
...
![image-20201222213006536](2.图论/image-20201222213006536.6ba634ed.png)
...
![image-20241014124235167](2.图论/image-20241014124235167.png)

添加 `16 `时，没有数据，直接新建一个节点，放进去。添加 `24 `时，发现有一个节点了，并且比` 16 `大，此时该节点中只有一个数据，则将 `24 `放在 `16 `的右边。

- **添加 12**

![image-20201222220054922](2.图论/image-20201222220054922.4bb0c572.png)
...
![image-20201222220658607](2.图论/image-20201222220658607.7e19b48d.png)

- **添加 14**

这个也简单，直接添加到` 12 `的右边，变成 `12,14`

![image-20201222220819603](2.图论/image-20201222220819603.47306946.png)

- **添加 26**

此时应该添加到 `24,32` 的中间(`26介于24 - 32`)，但一个节点只能添加两个数据，那么就**需要拆分**。

![image-20201222221007671](2.图论/image-20201222221007671.4cd4fac3.png)
...
![image-20201222221737672](2.图论/image-20201222221737672.96aa55f1.png)
...
![image-20201222222211562](2.图论/image-20201222222211562.e35fc788.png)
...
![image-20201222223140613](2.图论/image-20201222223140613.44b569bb.png)

- **添加 28**

![image-20201222223425500](2.图论/image-20201222223425500.4f29c845.png)
...
![image-20201222223829797](2.图论/image-20201222223829797.1834a017.png)

- **添加 20**

这个也简单，直接组成 `20,24`

![image-20201222223916961](2.图论/image-20201222223916961.448151e2.png)
...
![image-20201223212903438](2.图论/image-20201223212903438.4e8c218e.png)
...
![image-20201223214612995](2.图论/image-20201223214612995.cbe59331.png)
...
![image-20201223215140821](2.图论/image-20201223215140821.2410bce6.png)
...
![image-20201223220236107](2.图论/image-20201223220236107.a72d6e7a.png)
...
![img](2.图论/20220307160017-1723797363701-250.png)
...
![img](2.图论/20220308151436-1723797363701-254.png)
...
![环形图和无环图](2.图论/20220317115641-1723797363701-253.png)
...
![img](2.图论/20220317163249-1723797363701-251.png)
...
![img](2.图论/20220317133500-1723797363701-252.png)
...
![img](2.图论/20220317135207-1723797363701-255.png)
...
![img](2.图论/20220317161454-1723797363701-258.png)
...
![image-20230305080154969](2.图论/image-20230305080154969-1721820002716-7-1723797363701-259.png)
...
![img](2.图论/251320242183855.jpg)

**带权图**：对于带权值的网图，可以在边表结点定义中再增加一个`weight`的数据域，存储权值信息即可，如下图所示。

![img](2.图论/251322424211567.jpg)
...
![img](2.图论/20220317161217-1723797363701-263.png)
...
![image-20230302112003101](2.图论/image-20230302112003101-1721820002717-31-1723797363701-264.png)
...
- 选择起始节点 u，并将其标记为已访问。
  ...
  ![深度优先搜索 1](2.图论/202309042321406-1723797363701-265.png)

- 检查当前节点是否为目标节点（看具体题目要求）。

  ![深度优先搜索 2](2.图论/202309042323911.png)

- 如果当前节点 u 是目标节点，则直接返回结果。

  ![深度优先搜索 3](2.图论/202309042324370.png)

- 如果当前节点 u 不是目标节点，则遍历当前节点 u 的所有未访问邻接节点。

  ![深度优先搜索 4](2.图论/202309042325587.png)

- 对每个未访问的邻接节点 v，从节点 v 出发继续进行深度优先搜索（递归）。

  ![深度优先搜索 5](2.图论/202309042325689-1723797363701-266.png)

- 如果节点 u 没有未访问的相邻节点，回溯到上一个节点，继续搜索其他路径。

  ![深度优先搜索 6](2.图论/202309042325770-1723797363701-267.png)
...
![广度优先搜索 1](2.图论/20230905152316-1723797363701-269.png)

- 从队列中取出一个节点，访问它并将其所有的未访问**邻接节点 v** 放入队列中，也就是访问这个节点的所有子节点。

![广度优先搜索 2](2.图论/20230905152327-1723797363701-268.png)

- 标记已访问的节点 v，以避免重复入队。

![广度优先搜索 3](2.图论/20231009141628-1723797363701-272.png)

- 访问完一个节点的所有领接点就将这个节点出队

![广度优先搜索 4](2.图论/20230905152401-1723797363701-270.png)

- 重复步骤 上述步骤

![广度优先搜索 5](2.图论/20230905152420-1723797363701-271.png)

- 将队列中的节点出队

![广度优先搜索 6](2.图论/20230905152433-1723797363701-274.png)

- 结点出队，队列为空算法结束

![广度优先搜索 7](2.图论/20230905152445-1723797363701-273.png)
...
![image-76](2.图论/image-76-1728968364992-35.png)
...
![image-77](2.图论/image-77-1728968396032-38.png)

还有一个列表用来记录哪些节点未被访问（即尚未被包含在路径中）

![image-78](2.图论/image-78.png)

> 记住，当所有节点都被添加到路径中时，算法的计算过程就完成了。

我们选择了从节点 `0` 出发，可以直接将它标记为“已访问”，同样的，在未访问节点列表中把它划掉，并在图中给它加上红色的边框：

![image-87](2.图论/image-87-1728968447147-43.png)

![image-83](2.图论/image-83.png)

现在需要检查节点 `0` 到相邻节点的距离，两个相邻节点分别是节点 `1` 和节点 `2`（注意看红色的边）：

![image-89](2.图论/image-89-1728968531694-48.png)
...
![image-94](2.图论/image-94.png)

在距离列表中用**红色方块标记这个节点**，表明它是“已访问”的、已经寻找到了访问这个节点的最短路径：

![image-92](2.图论/image-92.png)

在未访问节点列表中将它划掉：

![image-93](2.图论/image-93.png)
...
![image-105](2.图论/image-105.png)

现在需要选择将哪个未访问节点标记为“已访问”，这里选择节点 `4`，因为在距离列表中它的距离最短。在图中做标记：

![image-108](2.图论/image-108.png)

在距离列表中用红色方块将它标记为“已访问”：

![image-107](2.图论/image-107.png)

在“未访问”节点列表中把它划掉：

![image-109](2.图论/image-109.png)

再次重复前面的过程。检查相邻节点：节点 `5` 和节点 `6`。分析每一种从已访问节点到它们之间的可能路径方案。

![image-108](2.图论/image-108-1728969012557-98.png)
...
![image-110](2.图论/image-110.png)

把距离最短（当前已知）的节点 `6` 标记为“已访问”。

![image-140](2.图论/image-140-1728969047612-106.png)

在“未访问”节点列表中把它划掉：

![image-111](2.图论/image-111.png)

现在得到了如下路径（标记为红色）：

![image-112](2.图论/image-112.png)
...
![image-113](2.图论/image-113.png)

选择总距离为 **22** 的最短路径：`0 -> 1 -> 3 -> 5`。

![image-115](2.图论/image-115.png)

把这个节点标记为“已访问”，并在“未访问”节点列表中把它划掉：

![image-114](2.图论/image-114.png)

![image-116](2.图论/image-116.png)

**瞧！** 我们得到了从节点 `0` 到图中每个节点的最短路径。

![image-115](2.图论/image-115-1728969120228-121.png)
...
![image-20230302204110774](2.图论/image-20230302204110774-1721820002717-25-1723797363701-282.png)
...
![img](2.图论/v2-3253617aa1280adbe911e9fae4133584_720w-1721820002717-29-1723797363701-286.webp)

迭代到源点连接的点上，将无穷松弛为经过的路径，在连接的节点处更新权值，权值为经过路径值的和。

![img](2.图论/v2-b79ce7e33dcee4a3e915bd1d1d2866e7_720w-1721820002717-30-1723797363701-285.webp)

对于迭代到的其他结点，重复上序的操作，重复次数为`|V|-1`；V表示当前图的节点个数

![img](2.图论/v2-f407fdcc6ac680d357f535258e3f12d8_720w-1721820002717-32-1723797363701-287.webp)

它的时间复杂度为 `O(VE)`，其中 `V` 是顶点数，`E`是边数。`Bellman-Ford` 算法的基本思想是对所有的边进行 `V-1 `轮松弛操作，以求出所有可能的最短路径。如果在第 `V`轮松弛操作中仍然存在松弛的边，则说明图中存在负权环。

![img](2.图论/v2-0b8efc7f4fcf5d767fc7b678c1d08c8c_720w-1721820002717-37-1723797363701-289.webp)
...
![img](2.图论/1009519-20160914091511945-721730394.png)

源点A首先入队，并且AB松弛

![img](2.图论/1009519-20160914094951008-1837307522.png)

扩展与A相连的边，B，C 入队并松弛。

![img](2.图论/1009519-20160914095106320-1643409246.png)

B，C分别开始扩展，D入队并松弛

![img](2.图论/1009519-20160914095216664-1709258627.png)

D出队，E入队并松弛。

![img](2.图论/1009519-20160914095322055-435785201.png)

E出队，**此时队列为空**，源点到所有点的最短路已被找到，A->E的最短路即为8

![img](2.图论/1009519-20160914095530086-1565146.png)
...
![image-20210825234854353](2.图论/91845da53560b397ea6d712e0c949875.png)
...
![image-20210826102018687](2.图论/887f643a9d56cfff7875350706411af6.png)
...
![image-20210826115604710](2.图论/ed8ed40446bbf499db28f35bb7dc7f27.png)
...
![0096-mst-prim.png](2.图论/0096-mst-prim.png)

![0096-mst-prim.gif](2.图论/0096-mst-prim.gif)
...
![0096-mst-prim-immediate.png](2.图论/0096-mst-prim-immediate.png)

- 优先队列

![0096-mst-prim-immediate-pq.png](2.图论/0096-mst-prim-immediate-pq.png)

从图解中看到四条边：`7-2, 7-4, 0-4, 0-2` 都是横切边，而 `7-2` 和 `7-4` 已经失效，因为 `0-4` 和 `0-2` 权重更小；对于优先队列始终只存储非树顶点 `2, 4` 到树中 `0, 7` 的最小权重横切边，即只存储 `0-4, 0-2` 。

- 图解

![0096-mst-prim-immediate-show.png](2.图论/0096-mst-prim-immediate-show.png)

- 演示

![0096-mst-prim-immediate.gif](2.图论/0096-mst-prim-immediate.gif)
